...
class LangChainCFG:
    ...
    llm_model_name = '/Users/yuan/CodeRoom/models/chatglm3-ggml-q4_0.bin'  # 本地模型文件 or huggingface远程仓库
    embedding_model_name = '/Users/yuan/CodeRoom/models/text2vec-large-chinese'  # 检索模型文件 or huggingface远程仓库
